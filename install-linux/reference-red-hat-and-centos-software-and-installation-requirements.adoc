...
* Red Hat Enterprise Linux或CentOS 7.x和8.x版、基于x86_64架构
...
* MySQL社区版8.0.21 (从MySQL存储库)。确保已删除先前安装的任何MySQL 5.7版本。由于问题描述具有互操作性， Unified Manager 的安装程序仅支持 MySQL 社区版 8.0.21 。您必须*不*将MySQL升级到8.0.21以上的版本。
